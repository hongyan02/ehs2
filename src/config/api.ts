export const API_SERVICE = {
    ...
    lock: {
        ...
        applicationPracticeCompleted: process.env.NEXT_PUBLIC_API_CONFIG_LOCAL + "/lock/application/practice-completed",
        applicationGenerateLockNumber: process.env.NEXT_PUBLIC_API_CONFIG_LOCAL + "/lock/application/generate-lock-number",
        applicationExportPracticeRecords: process.env.NEXT_PUBLIC_API_CONFIG_LOCAL + "/lock/application/export-practice-records",
